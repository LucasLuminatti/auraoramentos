...
**Plans**: 3 plans
- [ ] 21-01-PLAN.md — Fundação: migration sistema='s_mode' (12 perfis + 15 difusos) + helpers puros (calcularMetragemModulosDifusos, parsearComprimentoModulo, clonarItemLuminaria, fix clonarAmbiente) + filtro 'modulo_difuso'
...
| 21. SYSTEM MOLD + Validação & Reuso | v1.3 | 0/3 | Not started | - |
