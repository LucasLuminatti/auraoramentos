...
<task type="auto">
  ...
  <verify>
    <automated>grep -c "export function gerarOrcamentoHtmlV2" src/lib/pdfTemplates/v2.ts && ! grep -E "info-grid|Outfit|var\(--blue|#2E78A6|📦|🛡|💳|📋" src/lib/pdfTemplates/v2.ts && npm run build</automated>
  </verify>
  <acceptance_criteria>
